...
| 12  | The top N populated cities in the world where N is provided by the user. | Yes |  ![12-citiesTopNWorld](images/1-citiesTopNWorld.PNG)   |
| 13  | The top N populated cities in a continent where N is provided by the user. | Yes |  ![13-citiesTopNContinent](images/1-citiesTopNContinent.PNG)   |
| 14  | The top N populated cities in a region where N is provided by the user. | Yes |  ![14-citiesTopNRegion](images/1-citiesTopNRegion.PNG)   |
| 15  | The top N populated cities in a country where N is provided by the user. | Yes |  ![15-citiesTopNCountry](images/15-citiTopNCountry.PNG)   |
| 16  | The top N populated cities in a district where N is provided by the user. | Yes |  ![16-citiesTopNDistrict](images/16-citTopNDistrict.PNG)   |
